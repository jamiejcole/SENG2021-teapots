 ...
 *     responses:
 *       201:
 *         description: User created successfully. Check your email for 2FA code.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 * /api/v2/auth/login:
 *   post:
 *     summary: Sign in and receive access tokens
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 *       403:
 *         description: Signup 2FA verification has not been completed
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *   post:
 *     summary: Verify signup 2FA code and get access token
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200:
 *         description: 2FA verified successfully. Access token provided.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 *       401:
 *         description: Invalid userId or verification failed
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *   post:
 *     summary: Request a password reset magic link
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *   post:
 *     summary: Reset a password using a magic link token
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
